...
$(document).ready(function() {
    var $component = $('.nyl-static-forms-corp-governance-feedback');
    var validator;
    var modal;
    ...
    function _postFormData(formData) {
        var postData = {
            component: 'static-forms-corp-governance-feedback',
            options: formData
        };
        ...
        $.ajax({
            ...
            success: function(result) {
                if (result.status === 'OK') {
                    _buildModal('static-forms-corp-governance-feedback', 'success');
                ...
                _buildModal('static-forms-corp-governance-feedback', 'error', errorCode);
                NYL.forms.destroySpinner();
            },
            error: function(errorResult) {
                console.warn('Failed to post Static Forms Corp Governance Feedback data to service');
            }
        });
    }
